...
export default class UserLogin extends Component {
  ...
  handleSubmit = (e) => {
    ...
    this.refs.form.validateAll((errors, values) => {
      if (errors) {
        ...
        Toast.error('请检查数据是否有效后，在操作！');
        return;
      }
      Axios({
        url: 'welend/auth/login',
        method: 'post',
  ...
  onCaptchaClick = () => {
    ...
    console.log(time);
    this.setState({
      captcha: '/welend/auth/captcha?key=' + time,
    });
  }
                ...
                <Row style={styles.formItem}>
                  <Col>
                    <IceIcon
                      ...
                      style={styles.inputIcon}
                    />
                    {/* <IceFormBinder name="captcha" required message="必填">
                      <Input placeholder="验证码" />
                    </IceFormBinder> */}
                    {/* <Button style={styles.captcha} type="primary" onClick={this.onCaptcha}>
                      获取验证码
                    </Button> */}
                    {/* <span style={styles.captcha} onClick={this.onCaptchaClick}><Img src={this.state.captcha} /></span> */}
                  </Col>
                  <Col>
