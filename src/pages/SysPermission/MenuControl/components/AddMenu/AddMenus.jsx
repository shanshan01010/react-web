  ...
  validateAllFormField = () => {
    this.refs.form.validateAll((errors, values) => {
      ...
      const Succeed = () => {
        ...
        hashHistory.push('/sysPermission/menu');
      };
      const Fail = () => {
        Toast.error('添加菜单失败！');
      };
      DataCommonAxios('/welend/sys/menu/add', values, Succeed, Fail);
    });
  };
        ...
        <IceContainer>
          ...
          >
            <div style={styles.formContent}>
              <h2 style={styles.formTitle}>添加菜单</h2>
