          ...
          >
            <div>
              ...
              <Row>
                <Col span={4}>
                  {this.props.value.href === '' || this.props.value.href == null || this.props.value.href.length <= 0 ? (
                    <span style={styles.label}>菜单描述：</span>
                  ) : (
                    <span style={styles.label}>按钮描述：</span>
                  )}
                </Col>
                <Col span={18}>
                  <IceFormBinder>
                    <Input style={styles.formField} name="description" />
                  </IceFormBinder>
                </Col>
              </Row>
              {
              ...
              <Row>
                ...
                <Col span={8}>
                  <IceFormBinder required max={20} triggerType="onBlur" message="必填">
                    <Input style={styles.formField} name="sort" />
                  </IceFormBinder>
                  <IceFormError name="name" />
                </Col>
              </Row>
              ...
              <Row>
                ...
                <Col span={18}>
                  <IceFormBinder >
                    <Input style={styles.formField} name="permission" />
                  </IceFormBinder>
                </Col>
              </Row>
