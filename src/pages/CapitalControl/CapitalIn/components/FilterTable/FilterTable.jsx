...
const TableDataBinders = AllFunction.TableDataBinder('/welend/funds/moneyIn/list', false);
const updateBindingDatas = AllFunction.updateBindingData('/welend/funds/moneyIn/list');
      ...
      <div className="filter-table">
        ...
        <IceContainer>
          <Table
            ...
            hasBorder={false}
          >
            <Table.Column title="充值姓名" dataIndex="chnName" width={100} />
            <Table.Column title="充值金额" dataIndex="money" width={80} />
            <Table.Column title="渠道" dataIndex="channel" width={100} />
            <Table.Column title="支付方式" dataIndex="payType" width={85} />
            <Table.Column title="充值手续费" dataIndex="fee" width={85} />
            <Table.Column
              title="充值时间"
