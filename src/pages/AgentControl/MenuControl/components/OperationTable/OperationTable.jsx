...
const tableDatas = AllFunction.TableDataBinder('/welend/agency/menu/list', false);
const updateBindingDatas = AllFunction.updateBindingData('/welend/agency/menu/list');
  ...
  onEditMenuClick = (record, e) => {
    ...
    EditorInfoDialog.show({
      ...
      onOk: (that) => {
        ...
        DataCommonAxioss('/welend/agency/menu/update', that.state.value, Succeed, Fail);
      },
      onClose: () => {
        EditorInfoDialog.hide();
      },
  ...
  onAddChildMenuClick = (record, e) => {
    ...
    AddChildrenMenu.show({
      ...
      onOk: (that) => {
        ...
        DataCommonAxioss('/welend/agency/menu/add', that.state.value, Succeed, Fail);
      },
      onClose: () => {
        AddChildrenMenu.hide();
      },
  ...
  onDeleteMenuClick = (record, e) => {
    ...
    Dialog.confirm({
      ...
      onOk: () => {
        ...
        DataCommonAxioss('/welend/agency/menu/delete', record, Succeed, Fail);
      },
    });
  }
  ...
  renderOperations = (value, index, record) => {
    ...
    return (
      <div className="operation-table-operation" style={styles.operationTable}>
        ...
        {
          findPermission(permission, 'agency:menu:update') ?
          (
            <span
        ...
        {
          findPermission(permission, 'agency:menu:delete') ?
          (
          ...
          <Loading visible={this.state.loadVisible} style={styles.loadStyle} shape="flower">
            ...
            >
              ...
              />
              {
                !findPermission(permission, 'agency:menu:add') &&
                !findPermission(permission, 'agency:menu:update') &&
                !findPermission(permission, 'agency:menu:delete') ? null : (
                  <Table.Column
                    title="操作"
                    dataIndex="operation"
                    width={100}
