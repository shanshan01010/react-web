  ...
  validateAllFormField = () => {
    this.refs.form.validateAll((errors, values) => {
      ...
      if (!errors || errors === null) {
        ...
        DataCommonAxios('/welend/agency/user/add', values, Succeed, Fail);
      }
    });
  };
          ...
          >
            <div style={styles.formContent}>
              ...
              <Row style={styles.formItem}>
                ...
                <Col s="12" l="5">
                  <IceFormBinder name="amount" triggerType="onBlur" required message="必填">
                    <Input
                      size="large"
                      placeholder="请输入账号"
                      style={{ width: '100%' }}
                ...
                <Col s="12" l="5">
                  <IceFormBinder name="realName" triggerType="onBlur" required message="必填">
                    <Input
                      size="large"
                      placeholder="请输入昵称"
                      style={{ width: '100%' }}
              ...
              <Row style={styles.formItem}>
                ...
                <Col s="12" l="10">
                  <IceFormBinder name="roleId" required message="必填">
                    <Select
                      style={{ width: '50%' }}
                      size="large"
                      placeholder="请选择角色"
